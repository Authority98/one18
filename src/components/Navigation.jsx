    ...
    return (
        <nav className="fixed w-full z-50 px-4 md:px-6 py-4 transition-all duration-300">
            <div className={`max-w-7xl mx-auto backdrop-blur-md border border-[#2C1810]/10 rounded-full px-6 transition-all duration-300 flex justify-between items-center shadow-lg relative z-50 ${isScrolled ? 'bg-white/95 py-2' : 'bg-white/80 py-3'}`}>
                <a href="#" className="text-2xl font-bold tracking-tighter relative group text-[#2C1810]">
                ...
                <div className="hidden md:flex items-center space-x-8 font-medium text-sm uppercase tracking-widest text-[#2C1810]">
                    <a href="#supreme" className="hover:text-[#E07A5F] transition-colors">The Supreme</a>
                    <a href="#menu" className="hover:text-[#E07A5F] transition-colors">Menu</a>
