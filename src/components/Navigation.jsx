...
const Navigation = ({ isScrolled, onMobileMenuToggle }) => {
    return (
        <nav className="fixed w-full z-50 px-4 md:px-6 py-4 transition-all duration-300">
            <div className={`max-w-7xl mx-auto backdrop-blur-md border border-[#2C1810]/10 rounded-full px-4 md:px-6 transition-all duration-300 flex justify-between items-center shadow-lg relative z-50 ${isScrolled ? 'bg-white/95 py-2' : 'bg-white/80 py-3'}`}>
