    ...
    return (
        <section className="py-32 bg-gradient-to-br from-[#1a1410] via-[#2a1e19] to-[#1a1410] text-[#F4F1DE] relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#E07A5F]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#F4F1DE]/5 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4"></div>
            </div>
